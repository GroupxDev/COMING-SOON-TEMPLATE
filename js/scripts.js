...
(function($) {
    ...
    $(document).ready(function(){
        ...
        var countdownDate = "19 January 2016 15:00:00"; //date format: DD MONTH YYYY HH:MM:SS
        ...
        if (deviceDesktop===false) { //fix height: 100vh on some mobile browsers
            $(window).resize(function(){
                windowResize();
                  ...
                  // Video
                  var video = document.getElementById("hcrvideo");
                ...
                jQuery.ajax(
                    {
                        ...
                        success:function(data)
                        {
                            ...
                            jQuery("#contact-form-response").hide().html('<div class="form-info box-half-space"><span class="fa fa-envelope fa-fw"></span>Thank You! Your message has been sent.</div>').fadeIn();
                            jQuery.scrollTo('#contact-form-response');
                        },
                        error: function(jqXHR, textStatus, errorThrown)
                        {
                            jQuery("#contact-form-response").hide().html('<div class="form-info box-half-space"><span class="fa fa-exclamation-circle fa-fw"></span>Connection error occurred. Message not sent.</div>').fadeIn();
                            jQuery.scrollTo('#contact-form-response');
                        }
                    });
